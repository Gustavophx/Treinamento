...
def obter_autores(autor):
    # Guarda a informação em uma variavel, "no caso autores = "
...
def obter_autor_por_id(autor, id_autor):
    ...
    # Formato utilizado para retorna em forma de lista, formatado. (dicionario)
...
if __name__ == '__main__':
    app.run(debug=True, port=os.getenv("PORT", defalt=5000))
