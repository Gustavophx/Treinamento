...
import random
print('----- Olá, bem-vindo a nossa empresa -----')#dica do professor
usuario = input('Digite seu Nome ')
idade = input('Digite sua idade ')#lembra de colocar int(input('frase')) assim ele só aceitarar numero inteiro.
data_de_registro = datetime.today().strftime('%d/%m/%Y')# Se colocar so datetime.strptime nas proximas linhas lembrar de formatar se for pra algo especifico
#como dd/mm/aaaa Ex {data_de_registro.day}/{data_de_registro.month}/{data_cadastro.year}.
cartoes = ['R$50,00','R$250,00','R$120,00']
...
print(f'Olá {usuario}, seu registro foi concluído com sucesso no dia {data_de_registro}.\nParabéns, houve um sorteio e você ganhou um cartão de compras no valor de {sorteio}')
